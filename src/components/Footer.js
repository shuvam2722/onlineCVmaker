...
const teamMembers = [
    { name: "Shuvam Halder", github: "https://github.com/shuvam2722" },
            ...
            <Row className="justify-content-md-center">
                ...
                <Col md="auto">
                    <div className="p-4">
                        ...
                        <p><i className="fa fa-home mr-3"></i> Kolkata,India</p>
                        <p><i className="fa fa-envelope mr-3"></i> shuvamhalder2017@gmail.com</p>
                        <p><i className="fa fa-phone mr-3"></i> +91 9609604995</p>
                        <p><i className="fa fa-print mr-3"></i> Available</p>
                    </div>
                </Col>
